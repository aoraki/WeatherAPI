...
public class WeatherAPIIntegrationTests {
    ...
    @Test
    void queryMetricsSuccessMaximumStatsTwo(){
        final StatsQueryRequestDTO statsQueryRequestDTO = testUtils.generateStatsQueryRequestDTO(Arrays.asList(7L, 8L), StatType.MAX, false, false, false, false, true, "2023-05-10", "2023-06-07");
        ...
        assertThat(statsQueryResponseDTO.metricResponses.size()).isEqualTo(1);
        assertThat(statsQueryResponseDTO.metricResponses.get(0).getMetricResponseDTOByType(statsQueryResponseDTO.metricResponses, MetricType.HUMIDITY).metric).isEqualTo(MetricType.HUMIDITY);
        assertThat(statsQueryResponseDTO.metricResponses.get(0).getMetricResponseDTOByType(statsQueryResponseDTO.metricResponses, MetricType.HUMIDITY).metricValue).isEqualTo(81.0);
    }

    @Test
    void queryMetricsSuccessSumStatsOne(){
        final StatsQueryRequestDTO statsQueryRequestDTO = testUtils.generateStatsQueryRequestDTO(null, StatType.SUM, true, false, true, false, false, "2023-05-20", "2023-05-30");
        ...
        assertThat(statsQueryResponseDTO.metricResponses.size()).isEqualTo(1);
        assertThat(statsQueryResponseDTO.metricResponses.get(0).getMetricResponseDTOByType(statsQueryResponseDTO.metricResponses, MetricType.RAINFALL).metric).isEqualTo(MetricType.RAINFALL);
        assertThat(statsQueryResponseDTO.metricResponses.get(0).getMetricResponseDTOByType(statsQueryResponseDTO.metricResponses, MetricType.RAINFALL).metricValue).isEqualTo(363.0);
    }

    @Test
    void queryMetricsSuccessSumStatsTwo(){
        final StatsQueryRequestDTO statsQueryRequestDTO = testUtils.generateStatsQueryRequestDTO(Arrays.asList(4L), StatType.SUM, false, false, false, false, true, "2023-05-25", "2023-06-01");
        ...
        assertThat(statsQueryResponseDTO.metricResponses.size()).isEqualTo(1);
        assertThat(statsQueryResponseDTO.metricResponses.get(0).getMetricResponseDTOByType(statsQueryResponseDTO.metricResponses, MetricType.HUMIDITY).metric).isEqualTo(MetricType.HUMIDITY);
        assertThat(statsQueryResponseDTO.metricResponses.get(0).getMetricResponseDTOByType(statsQueryResponseDTO.metricResponses, MetricType.HUMIDITY).metricValue).isEqualTo(68.0);
    }
